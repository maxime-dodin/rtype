...
void follow_system([[maybe_unused]] Registry &r, sparseArray<Follow> &followArr, sparseArray<Position> &posArr, sparseArray<Velocity> &velArr, [[maybe_unused]]MyClock &clock)
{
